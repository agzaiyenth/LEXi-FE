  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>
        Pop the Balloon is a fun, interactive game for dyslexic students to
        improve reading and cognitive skills. Players pop balloons with letters,
        words, or numbers to complete challenges, enhancing focus and phonetic
        awareness. Adjustable difficulty ensures an enjoyable learning
        experience!
      </Text>
